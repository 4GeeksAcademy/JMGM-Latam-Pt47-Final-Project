...
export const Landing = () => {
    ...
    return (
        <>
            ...
            {/* cards */}
            <div className='d-flex p-4 mx-2 justify-content-evenly row container-fluid'>
                <div className="card mb-md-3 mb-5 col-md-4 col-xs-12 text-center px-0" style={{ maxWidth: "18rem", boxShadow: "0px 0px 10px rgba(0, 0, 0, 0.5)" }}>
