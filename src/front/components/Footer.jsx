...
export const Footer = () => {
	...
	return (
		<footer className="footer mt-auto py-3 text-center border-top" style={{ backgroundColor: "white" }}>
			<div className="container-fluid d-flex justify-content-center justify-content-md-between mb-2 row">
				<div className="col-3 d-flex justify-content-center justify-content-md-start px-4">
					<img src={logo} type="button" alt="Logo" width="105" height="40" className="d-inline-block align-text-top"></img>
				</div>
				<div className="d-flex justify-content-end px-5 row">
					<button type="button" className="btn col-12 col-md" href="/" onClick={() => { navigate("/") }}>Homepage</button>
					<button type="button" className="btn col-12 col-md" href="/" onClick={() => { navigate("/app") }}>Inicio</button>
					<button type="button" className="btn col-12 col-md" href="/" onClick={() => { navigate("/app/perfil") }}>Perfil</button>
					<button type="button" className="btn col-12 col-md" href="/" onClick={() => { navigate("/") }}>Contáctanos</button>
				</div>
			</div>
			<div className="container-fluid d-flex justify-content-between">
				<div className="col-md-3 col">
					<p className="text-start ps-3 px-0 px-md-5">¡Gestiona tu inventario de la mejor manera!
						<br />
						Visualiza tu Stock en MyStock</p>
				</div>
				<div className="d-flex justify-content-end px-5 fs-4 row">
					<button type="button" className="btn btn-link col-12 col-md"><i className="fa-brands fa-square-facebook" style={{ fontSize:"max(2vw, 30px)", color: "#6C11D9" }} /></button>
					<button type="button" className="btn btn-link col-12 col-md"><i className="fa-brands fa-square-instagram" style={{  fontSize:"max(2vw, 30px)", color: "#6C11D9" }} /></button>
					<button type="button" className="btn btn-link col-12 col-md"><i className="fa-brands fa-square-twitter" style={{  fontSize:"max(2vw, 30px)", color: "#6C11D9" }} /></button>
				</div>
			</div>
