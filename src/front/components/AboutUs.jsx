...
function AboutUs() {
    return <>
            <div className="container-fluid mt-3 text-center" style={{background: "#6C11D9"}}>
                <div className="row g-0 align-items-center container-fluid">
                    <div className="col-md-6">
                        <img src={img2} className="img-fluid" alt="https://cdn.pixabay.com/photo/2018/01/11/06/26/construction-3075498_1280.jpg" />
                    </div>
                    <div className="col-md-6 d-flex align-items-center justify-content-center mt-md-0 mt-xs-3">
                        <div className="card-body card-text-center text-white" style={{ minHeight: '200px' }}>
                            <h1 className="card-title fw-bold mt-3 mt-md-0" >Sobre nuestra empresa</h1>
                            <div className='border w-50 my-3 mx-auto' />
                            <p className="card-text fs-5 px-3 mb-4 mb-md-0" >En <b>MyStock</b> nuestro propósito es simple, entregar un producto de calidad mediante un desarrollo ético, colaborativo 
        ...
        <div className="container-fluid text-center px-0" style={{background: 'white'}}>
            <div className="row g-0 flex-row-reverse align-items-center container-fluid">
                <div className="col-md-6">
                    <img src="https://images.unsplash.com/photo-1587293852726-70cdb56c2866" className="img-fluid" alt="..."/>
                </div>
                <div className="col-md-6  align-items-center justify-content-center">
                    <div className="card-body">
                        <h1 className="card-title fw-bold mt-3 mt-md-0">Nuestra misión</h1>
                        <div className='border w-50 my-3 mx-auto' />
